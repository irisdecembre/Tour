 ...
 * @author Admin
 */
public class delTour extends javax.swing.JFrame {
    ...
    public delTour() {
        ...
        jButton6.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!jTextField2.getText().equals("")) {
                    delTour fram5 = new delTour();
                    fram5.setVisible(true);
                    delTour.this.setVisible(false);
                }
            }
        });
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nhập mã tour cần xóa");

        jTextField2.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        jLabel9.setText("Vui lòng nhập mã tour cần xóa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delTour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
