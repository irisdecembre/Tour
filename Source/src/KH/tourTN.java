 ...
 * @author Admin
 */
public class tourTN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nơi đến", "Huế", "Phú Quốc", "Sapa", "Vịnh Hạ Long", "Hội An", "Cần Thơ" }));
        ...
        jLabelb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/PhuQuoc.jpg"))); // NOI18N

        jLabelb3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/HoiAn.jpg"))); // NOI18N

        jLabelb1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Hue.jpg"))); // NOI18N

        jTextFieldb1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jTextFieldb1.setText("HUẾ");
        jTextFieldb1.setBorder(null);

        jTextFieldb2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jTextFieldb2.setText("PHÚ QUỐC");
        jTextFieldb2.setBorder(null);

        jTextFieldb3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jTextFieldb3.setText("HỘI AN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tourTN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
